...
//client sending packet with checksum and sequence number, waits for
...
// set up reads file descriptor at the beginning of the function to be
...
//if the ckechsum and sequence numbers are correct, break and return to
